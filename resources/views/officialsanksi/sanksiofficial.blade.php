...
@section('container')
    <div class="container mt-5">
        <h3 class="font-weight-bold mb-5">Sanksi Official Tim</h3>
                ...
                @if (isset($data_official))
                    <div class="d-flex">
                        <a href='{{ route('sanksiprosesofficial', ['id' => $data_official->id]) }}'
                            ...
                            Lihat Proses Sanksi Official <i class="bi bi-chevron-right"></i>
                        </a>
                        <a href='{{ route('sanksihistoriofficial', ['id' => $data_official->id]) }}'
                            class="btn btn-primary mx-2">
                            Lihat Histori Sanksi Official <i class="bi bi-chevron-double-right"></i>
                        </a>
                    </div>
                @endif

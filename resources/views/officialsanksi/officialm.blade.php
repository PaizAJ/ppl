                                ...
                                <div class="row row-cols-1 row-cols-md-3 g-2">
                                    @foreach ($data_official as $item)
                                        <div class="col">
                                            <div class="card">
                                                <div class="card-body">
                                                    <h5 class="card-title">{{ $item->nama_official }}</h5>
                                                    <p class="card-text">Tanggal: {{ $item->tanggal_official }}</p>
                                                    <p class="card-text">Klub: {{ $item->klub_official }}</p>


                                                    <a href='{{ route('sanksiofficial', ['id' => $item->id]) }}'
